...
class HybridRiskEngine:
    ...
    def __init__(self, ml_weight: float = 0.6, graph_weight: float = 0.3, rule_weight: float = 0.1):
        """
    ...
    def evaluate_transaction(self, ml_score: float, graph_score: float, rules_breached: int, max_rules: int = 5) -> Dict[str, Any]:
        """
